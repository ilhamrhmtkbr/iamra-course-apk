...
import com.ilhamrhmtkbr.databinding.FragmentInstructorReviewsBinding;
...
public class ReviewsFragment extends Fragment {
    private FragmentInstructorReviewsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        binding = FragmentInstructorReviewsBinding.inflate(getLayoutInflater(), viewGroup, false);
