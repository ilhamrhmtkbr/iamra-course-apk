...
import com.ilhamrhmtkbr.databinding.FragmentUserAuthRegisterBinding;
...
public class RegisterFragment extends Fragment implements RecaptchaValidation {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        binding = FragmentUserAuthRegisterBinding.inflate(getLayoutInflater(), viewGroup, false);
    ...
    private void observeViewModel() {
        viewModel.getRegisterState().observe(getViewLifecycleOwner(), new Observer<FormState<String>>() {
            @Override
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                for (Map.Entry<String, String> entry : errors.entrySet()) {
                    ...
                    switch (field) {
                        case "first_name":
                            binding.inputLayoutFirstName.setError(error);
                            break;
                        case "middle_name":
                            binding.inputLayoutMiddleName.setError(error);
                            break;
                        case "last_name":
                            binding.inputLastName.setError(error);
                            break;
                        case "username":
    ...
    private void removeErrors() {
        ...
        binding.inputLayoutMiddleName.setError(null);
        binding.inputLayoutMiddleName.setError(null);
